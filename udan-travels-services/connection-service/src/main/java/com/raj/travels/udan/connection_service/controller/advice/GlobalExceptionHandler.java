...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<AuthenticationResponse> handleAmadeusException(AmadeusConnectionException ex,
                                                                         HttpServletRequest request) {
        log.error("AmadeusConnectionException occurred", ex);

        AuthenticationResponse error = AuthenticationResponse.builder()
    ...
    public ResponseEntity<AuthenticationResponse> handleUnableToGetConnectionException(UnableToGetConnectionException ex,
                                                                                       HttpServletRequest request) {
    ...
    public ResponseEntity<AuthenticationResponse> handleGenericException(Exception ex,
                                                                         HttpServletRequest request) {
