package com.raj.travels.udan.connection_service.mock.amadeus.client;
 ...
 */
@SpringBootTest
class AmadeusConnectionClientTest {
    @MockitoBean
    ...
    void testFetchConnection() {
        ...
        ConnectionResponse connectionResponse = amadeusConnectionClient.fetchConnection(connectionCredentials);
    ...
    void testFetchConnection_WithoutToken() {
        ...
        Assertions.assertThrows(ConnectionFailedException.class, () ->
                amadeusConnectionClient.fetchConnection(connectionCredentials));
    }
    ...
    void testFetchConnection_WithInvalidCredentials() {
        ...
        Assertions.assertThrows(ConnectionFailedException.class, () ->
                amadeusConnectionClient.fetchConnection(null));
    }
}
